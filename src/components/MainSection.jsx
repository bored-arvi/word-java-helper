  ...
  return (
    <section className="relative flex justify-center items-center h-screen px-4">
      ...
      <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl p-10 md:p-16 max-w-6xl text-center animate-fadeInUp">
        ...
        <button className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-10 py-4 rounded-full text-xl font-semibold hover:bg-white hover:text-black transition transform hover:scale-110 hover:shadow-xl duration-300">
  Upload Now
</button>
